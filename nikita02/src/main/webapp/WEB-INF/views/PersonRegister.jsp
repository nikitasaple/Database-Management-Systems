...
<section id="content">
	<br/>
	<center>
		<h2 style= "color: black">Person Register</h2>
	</center>
	
	<form:form action="personReg.htm" commandName="person" method="post">
		<center>
			<table>
				<tr>
				...
				<tr>
				    <form:input path="password" pattern="[a-zA-Z0-9]{3,15}" 
    required = "true" title="Minimum length of password should be 6 characters." type="password"/></tr>				
				...
				<tr>
				    ...
				    <td><br/><form:input path="phone" size="30" pattern="[0-9]"/> <font color="red"><form:errors path="phone"/></font></td>
				</tr>
				...
				<td><br/>
				<center>
				<a href="personReg.htm" class="btn">Clear</a></center></td>
				</tr>
			</table>
		</center>
	</form:form>
